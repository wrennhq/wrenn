...
func (EventType) Descriptor() protoreflect.EnumDescriptor {
	return file_filesystem_proto_enumTypes[1].Descriptor()
}

func (EventType) Type() protoreflect.EnumType {
	return &file_filesystem_proto_enumTypes[1]
}
...
func (*WatchDirResponse_StartEvent) Descriptor() ([]byte, []int) {
	return file_filesystem_proto_rawDescGZIP(), []int{13, 0}
}
...
func (*WatchDirResponse_KeepAlive) Descriptor() ([]byte, []int) {
	return file_filesystem_proto_rawDescGZIP(), []int{13, 1}
}
...
var file_filesystem_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
func file_filesystem_proto_init() {
	...
	file_filesystem_proto_msgTypes[8].OneofWrappers = []any{}
	file_filesystem_proto_msgTypes[13].OneofWrappers = []any{
